...
(function () {
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function setTitleLines(id, lines, fallback) {
            const element = document.getElementById(id);
            if (!element)
                return;
            if (!lines.length) {
        ...
        function renderSurface(payload) {
            ...
            if (payload.hero) {
                ...
                setTitleLines('home-os-title', getLocalizedLines(payload.hero.title_lines, language), getLocalizedValue(payload.hero.title, language));
