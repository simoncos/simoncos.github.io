...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function seriesGroupKey(group, seriesName) {
    ...
    function existingLinkSuffixes() {
        ...
        seriesList.querySelectorAll('a[data-series-group][href]').forEach((anchor) => {
    ...
    function seriesRows(data, currentLanguage) {
        ...
        return [...seriesMap.entries()]
            ...
            seriesName,
            items: items.sort((itemA, itemB) => (partValue(itemA.group) - partValue(itemB.group)
