(function () {
    ...
    const translations = {
        en: {
            ...
            projects_lede: 'Independent project pages, data essays, and other standalone works that do not quite belong in the regular writing archive.',
            loading_projects: 'Loading projects...',
            no_projects_found: 'No projects found yet.',
        ...
        zh: {
            ...
            projects_kicker: 'Projects',
            projects_title: 'Projects',
            projects_lede: '这里收着独立项目页、数据随笔，以及那些不太适合放进常规博客归档里的作品。',
