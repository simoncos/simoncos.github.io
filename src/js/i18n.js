...
(function () {
    ...
    function localizeReadingTime(root = document) {
        root.querySelectorAll('[data-reading-minutes]').forEach((element) => {
    ...
    function localizeDocumentMetadata() {
        ...
        const titleElement = document.querySelector('title[data-i18n-doc-title]');
        if (titleElement) {
