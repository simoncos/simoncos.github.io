...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const tocDetails = tocContainer ? tocContainer.querySelector<HTMLDetailsElement>('details.toc-details') : null;
    ...
    function setScrollDirectionHidden(isHidden: boolean) {
